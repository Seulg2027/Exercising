...
import urllib.request # 특정 url에 request를 날릴 수 있도록 하는 코드
import json

client_id = "BzAAGYA9MS3cGvWe1ykh"
client_secret = "muv7KwNL4H"
...
request.add_header("X-Naver-Client-Id",client_id) #header에 url을 보내겠다는
